...
-- Provider route identity is unique within the authoritative offering intent.
ALTER TABLE private.offering_route_evidence
  DROP CONSTRAINT offering_route_evidence_provider_namespace_provider_product_key;

ALTER TABLE private.offering_route_evidence
  ADD CONSTRAINT offering_route_evidence_intent_provider_identity_key
  UNIQUE (
