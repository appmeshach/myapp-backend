...
The optional onContinueJourney callback appears only after the service reports activated. The current route supplies navigation to movement-coordination, which independently rechecks post-activation reveal authorization. No journey start/end functionality was added. Actual checkout, real payment and callback settlement remain blocked on provider/pricing work described above.
